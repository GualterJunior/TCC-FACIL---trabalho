...
@section('title', 'Dashboard - TCC Facil')
...
<div class="card mt-4">
    <div class="card-body">
        @if ($isStaff)
            <h2 class="h5">Area de avaliacao</h2>
            <p class="text-secondary mb-3">
                Use as opcoes abaixo para acompanhar entregas, validar trabalhos e registrar notas dos grupos.
            </p>
